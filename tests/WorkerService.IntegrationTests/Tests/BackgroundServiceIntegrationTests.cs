...
public class BackgroundServiceIntegrationTests : IClassFixture<WorkerServiceTestFixture>, IAsyncLifetime
{
    ...
    public BackgroundServiceIntegrationTests(WorkerServiceTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
